                ...
                <div v-if="can == true">
                  <div class="mt-2">
                    <p class="text-xs text-gray-500">
                      All Documents will display here (only viewed by Admin). 
                    </p>
                  </div>
                  <div class="mt-2 flex space-x-2">
                    <div class="flex-1">
                      ...
                      <!-- dmiomvwoidmviomwiovkmiowmviomwiomviowmovnoeniqughiue -->
                      <!-- <input
                      ...
                      <!-- fijvoiemoivevkemviokeoimvoiemoivmioemivomeoimvoiemoivmio -->
                      <!-- <input
                        type="file"
                        :disabled="can == false"
                      ...
                      <!-- <span
                        ...
                        >{{ errors.file[0] }}</span
                      > -->
  <!-- dsnvinsfijvnjdifn              Type Documents Name    diufviuebiufviueniuvniuen -->
                      <!-- <div class="mt-2 flex space-x-2">
                        <div class="flex-1">
                            <input
                              type="file"
                  ...
                  <div>
                    <table class="border-collapse mt-9">
                      <transition-group name="list" tag="p">
                        <tbody v-for="doc in docs" :key="doc.id">
                          <tr v-if="!type_document && !doc.type_document" class="hover:bg-grey-lighter">
                            <td>
                              <div
  ...
  export default {
    ...
    methods: {
      ...
      submit() {
        ...
        data.append("type_document", this.$props.type_document);
