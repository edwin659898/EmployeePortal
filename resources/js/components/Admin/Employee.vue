                ...
                <div v-if="showForm">
                  <div class="mt-2">
                    <p class="text-xs text-gray-500">
                      Some Fields such as Full names,DOB and National ID are
                      compulsory
                    </p>
                  </div>
                  ...
                  <div class="mt-2 flex space-x-2">
                    <div class="flex-1">
                      ...
                      <input
                        ...
                        "
                      />
                      <span class="text-sm text-red-600" v-if="errors.Pemail">{{
                        errors.Pemail[0]
                      }}</span>
                    </div>
                  </div>
