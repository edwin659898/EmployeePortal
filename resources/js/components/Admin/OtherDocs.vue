            ...
            <div class="p-3">
              ...
              <transition name="slide-fade">
                ...
                <div v-if="can == true">
                  <div class="mt-2">
                    <p class="text-xs text-gray-500">
                      Attach private documents below as required. i.e Warning<br>
                ...
                <!-- view last -->
                  ...
                  <div>
                    <table class="border-collapse mt-7">
                      <transition-group name="list" tag="p">
                        <tbody v-for="doc in docs" :key="doc.id">
                          <tr v-if="!is_type_document && !doc.is_type_document" class="hover:bg-grey-lighter">
                            <td>
                              <div
